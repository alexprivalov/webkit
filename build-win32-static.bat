...
cmake -S "%SRC%" -B "%BUILDDIR%" -G Ninja ^
  ...
  -DENABLE_VIDEO_PRESENTATION_MODE=OFF -DENABLE_MEDIA_CONTROLS_CONTEXT_MENUS=ON ^
...
for %%L in (icuuc icuin icudt woff2dec woff2common brotlidec brotlicommon sharpyuv harfbuzz-icu libxslt libexslt) do (
